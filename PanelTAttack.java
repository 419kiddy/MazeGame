...
public class PanelTAttack extends JPanel implements ActionListener, KeyListener {
  MainFrame mf;
  Dimension d;
  final int Width= 500;
  ...
  public PanelTAttack(MainFrame frame){
    mf=frame;
    me_size=70;
  ...
  public void paintComponent(Graphics g) {
    ...
    g.drawString("Time Attack Mode "+MainFrame.PD_flag+" "+MainFrame.PT_time,10,10);

    sec = (int)(MainFrame.PT_time/100);
    sec_str = Integer.toString(sec);
    c_sec = (MainFrame.PT_time%100);
    c_sec_str = Integer.toString(c_sec);
    g.setColor(Color.yellow);
    g.setFont(new Font("Century", Font.BOLD, 50));
    g.drawString(sec_str+"s"+c_sec_str,350,450);
  }
